...
- Adsorption Rate Constant (This is found using published values of the Henry's Law Constant of various PAHs and VOCs with Simualted values of k<sub>D</sub>)
